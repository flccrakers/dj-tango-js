...
var Align = function Align(_ref, ref) {
  ...
  var _useBuffer = (0, _useBuffer3.default)(function () {
    ...
    if (!latestDisabled && latestTarget) {
      var source = (0, _findDOMNode.default)(nodeRef.current);
      var result;
  ...
  _react.default.useEffect(function () {
    ...
    if (cacheRef.current.element !== element || !(0, _util.isSamePoint)(cacheRef.current.point, point)) {
      forceAlign(); // Add resize observer

      if (resizeMonitor.current.element !== element) {
        resizeMonitor.current.cancel();
        resizeMonitor.current.element = element;
        resizeMonitor.current.cancel = (0, _util.monitorResize)(element, forceAlign);
      }
    }
  ...
  _react.default.useEffect(function () {
    if (monitorWindowResize) {
      if (!winResizeRef.current) {
        winResizeRef.current = (0, _addEventListener.default)(window, 'resize', forceAlign);
      }
